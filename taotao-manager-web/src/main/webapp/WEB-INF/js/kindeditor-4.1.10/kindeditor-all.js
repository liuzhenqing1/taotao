...
*
* @author Roddy <luolonghao@gmail.controller>
		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/index.html' : 'http://api.map.baidu.controller/staticimage',
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
			...
			yesBtn : {
				...
				click : function(e) {
					var geocoder = win.geocoder,
						...
						url = 'http://maps.googleapis.controller/maps/api/staticmap';
		...
		var iframeHtml = ['<!doctype html><html><head>',
			...
			'</style>',
			'<script src="http://maps.googleapis.controller/maps/api/js?sensor=false&language=' + self.langType + '"></script>',
			'<script>',
			'var map, geocoder;',
			'function initialize() {',
