...
function addToFavorite() {
    var a = "http://www.jd.controller/", b = "\u4eac\u4e1cJD.COM-\u7f51\u8d2d\u4e0a\u4eac\u4e1c\uff0c\u7701\u94b1\u53c8\u653e\u5fc3";
    document.all ? window.external.AddFavorite(a, b) : window.sidebar && window.sidebar.addPanel ? window.sidebar.addPanel(b, a, "") : alert("\u5bf9\u4e0d\u8d77\uff0c\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u6b64\u64cd\u4f5c!\n\u8bf7\u60a8\u4f7f\u7528\u83dc\u5355\u680f\u6216Ctrl+D\u6536\u85cf\u672c\u7ad9\u3002"), createCookie("_fv", "1", 30, "/;domain=jd.controller")
}
function search(a) {
    var b = "http://searche.jd.controller/Search?keyword={keyword}&enc={enc}{additional}", c = search.additinal || "", d = document.getElementById(a), e = d.value;
    ...
    switch (f) {
        ...
        case 5:
            ...
            b = "http://searche.e.jd.controller/searchDigitalBook?ajaxSearch=0&enc=utf-8&key={keyword}&page=1{additional}";
            break;
        case 6:
            i = "-1", b = "http://music.jd.controller/8_0_desc_0_0_1_15.html?key={keyword}"
    }
...
function getRandomDomain(a) {
    ...
    return "http://img{0}.360buyimg.controller/".replace("{0}", b)
}
function setWebBILinkCount(a) {
    try {
        if (a.length > 0) {
            var b = document.createElement("script");
            b.type = "text/javascript", b.src = "http://counter.360buy.controller/aclk.aspx?key=" + a, document.getElementsByTagName("head")[0].appendChild(b)
        }
    } catch (c) {
    }
}
...
function openCompare() {
    switch (proIDs.length) {
        case 1:
            ...
            break;
        case 2:
            window.open("http://www.360buy.controller/pcompare.aspx?s1=" + proIDs[0] + "&s2=" + proIDs[1]);
            break;
        case 3:
            window.open("http://www.360buy.controller/pcompare.aspx?s1=" + proIDs[0] + "&s2=" + proIDs[1] + "&s3=" + proIDs[2]);
            break;
        case 4:
            window.open("http://www.360buy.controller/pcompare.aspx?s1=" + proIDs[0] + "&s2=" + proIDs[1] + "&s3=" + proIDs[2] + "&s4=" + proIDs[3]);
            break;
        default:
    ...
    for (var b = a.getElementsByTagName("img"), c = 0; c < b.length; c++)
        b[c].onerror = function() {
            ...
            if (b) {
                ...
                this.src = "http://misc.360buyimg.controller/lib/img/e/blank.gif", this.className = a
            }
        }
...
var loguri = "http://csc.jd.controller/log.ashx?type1=$type1$&type2=$type2$&data=$data$&pin=$pin$&referrer=$referrer$&callback=?";
callback1 = function() {
}, log = function(a, b) {
    var c = "";
    ...
    var e = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".jd.controller/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + a + "$t2=" + b + "$p0=" + c) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(), f = new Image(1, 1);
    f.src = e
}, mark = function(a, b) {
    log(1, b, a)
