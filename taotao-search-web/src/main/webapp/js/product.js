 /*
 item.jd.controller Compressed by uglify
 Author:keelii 
...
function setSearch(t, e) {
    ...
    $.ajax({url: "http://api.search.jd.controller/?key=" + s + "&pagesize=" + i + "&filt_type=wyn,L1M1;wstate,L1M1" + e,dataType: "jsonp",success: function(t) {
            var e = t.Summary.key;
            pageConfig.product.searchList = [], null !== t.Product && t.Product.length > 0 && (1 > $("#searche-result").length && $("#product-intro").parent().before('<div class="w"><div id="searche-result" class="m m2" clstag="shangpin|keycount|product|exrs"><div class="mt"></div><div class="mc searche-item"></div></div></div>'), $("#searche-result").show(), $("#searche-result .searche-item").html(search_TPL.process(t)), $("#searche-result .mt").html('<h2>\u5728\u4eac\u4e1c\u5546\u57ce\u4e2d\u67e5\u770b\u5176\u5b83\u201c<a target="_blank" href="http://searche.jd.controller/Search?keyword=' + e + '">' + e + '</a>\u201d\u7684\u641c\u7d22\u7ed3\u679c\uff1a</h2><div class="extra"><a target="_blank" href="http://searche.jd.controller/Search?keyword=' + e + '">\u67e5\u770b\u66f4\u591a\u641c\u7d22\u7ed3\u679c</a></div>'), G.getPriceNum(pageConfig.product.searchList, null, $("#searche-result")), $(".searche-item dl .p-img a").click(function() {
                var t = $(this).parents("dl").attr("skuid");
                $.getScript("http://sstat.jd.controller/scslog?args=1^" + encodeURIComponent(e) + "^^1^^" + encodeURIComponent(document.referrer) + "^" + t + "^0^101^^0^0")
            }), $(".searche-item dl .p-name a").click(function() {
                var t = $(this).parents("dl").attr("skuid");
                $.getScript("http://sstat.jd.controller/scslog?args=1^" + encodeURIComponent(e) + "^^1^^" + encodeURIComponent(document.referrer) + "^" + t + "^0^101^^0^0")
            }))
        }})
...
function seoBanner(t, e) {
    $.ajax({url: "http://seo.jd.controller/adrpc/source.action",data: {cateid: G.cat[0],type: 5,ison: 1 === warestatus ? !0 : !1},dataType: "jsonp",success: function(t) {
...
function getSuitInfoService(t) {
    if (null !== t.packResponseList && t.packResponseList.length > 0) {
        ...
        $("#favorable-suit").show(), $("#favorable-suit .mc").html(suit_TPL.tabs.process(t) + suit_TPL.cons.process(t)), $("#favorable-suit .mc").Jtab({event: e >= t.packResponseList.length ? "mouseover" : "click",delay: 300,compatible: !0,currClass: "scurr"}, function(t, e) {
            ...
            }), l.attr("href", "http://www.jd.controller/suit/show.html?suitId=" + s + "&skuIds=" + d.join(",")), e.find("img[data-src]").each(function() {
...
function onlineService(t, e, i) {
    ...
    g = g ? s(g) : "", i || (i = "chat.jd.controller");
...
function log(t, e) {
    ...
    for (i = 2; arguments.length > i; i++)
        s = s + arguments[i] + "|||";
    var a = decodeURIComponent(escape(getCookie("pin"))), n = "http://csc.360buy.controller/log.ashx?type1=$type1$&type2=$type2$&data=$data$&pin=$pin$&referrer=$referrer$&jinfo=$jinfo$&callback=?", o = n.replace(/\$type1\$/, escape(t));
    ...
    var r = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".jd.controller/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + t + "$t2=" + e + "$p0=" + s) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(), c = new Image(1, 1);
    c.src = r
}
...
function setCookie(t, e, i) {
    var s = i, a = new Date;
    a.setTime(a.getTime() + 1e3 * 60 * 60 * 24 * s), document.cookie = t + "=" + escape(e) + ";expires=" + a.toGMTString() + ";path=/;domain=.jd.controller"
}
function getCookie(t) {
    var e = document.cookie.match(RegExp("(^| )" + t + "=([^;]*)(;|$)"));
    return null != e ? unescape(e[2]) : null
...
function CombineShare(t) {
    ...
    }, t.title.length > 27 && (t.title = t.title.substr(0, 27) + "..."), this.shareParam = {sid: t.sid,rid: t.rid,title: t.title,content: t.content,imgUrl: this.imgs[0],url: t.url}, this.shareMap = {T2: {name: "sina",text: "\u65b0\u6d6a\u5fae\u535a",url: "http://share.jd.controller/sina/login.action"},T3: {name: "qqWeibo",text: "\u817e\u8baf\u5fae\u535a",url: "http://share.jd.controller/qqweibo/login.action"},T4: {name: "renren",text: "\u4eba\u4eba\u7f51",url: "http://share.jd.controller/renren/login.action"},T5: {name: "kaixin",text: "\u5f00\u5fc3\u7f51",url: "http://share.jd.controller/kaixin001/login.action"},T6: {name: "douban",text: "\u8c46\u74e3\u7f51",url: "http://share.jd.controller/douban/login.action"}}, this.init()
}
if (G === void 0)
    var G = window.G = {};
(function(t) {
...
//        , $.ajax({url: "http://club.jd.com/ProductPageService.aspx?method=GetCommentSummaryBySkuId&referenceId=" + t + "&callback=getCommentCount",dataType: "script",cache: !0})
        ...
        t = t || [], e = e || $("body").eq(0), i = i || "p-comm-", s = s || "(\u5df2\u6709{NUM}\u4eba\u8bc4\u4ef7)", $.ajax({url: "http://club.jd.controller/clubservice.aspx?method=GetCommentsCount&referenceIds=" + t,dataType: "jsonp",success: function(t) {
                var e;
        ...
        for (var i = $(t).parents(e), s = i.find(".master input").attr("wmeprice"), a = i.find("input:checked"), n = a.length, o = i.find(".infos .res-totalprice"), r = i.find(".infos .res-jdprice"), c = 0, l = 0, d = "http://cart.jd.controller/cart/dynamic/reBuyForOrderCenter.action?wids={SKUS}&nums={NUMS}", p = i.find(".btn-buy"), m = [], u = 0; a.length > u; u++)
        ...
        var i = "http://mercury.jd.controller/log.gif?", s = "src=" + t.name + "$action=" + t.action;
        ...
        "function" == typeof t && $.getJSON("http://passport.jd.controller/loginservice.aspx?method=Login&callback=?", function(e) {
        ...
        var n = new Image, o = "http://mercury.jd.controller/log.gif?t=rec." + t + "&v=" + encodeURIComponent("src=rec$action=" + e + "$enb=1$sku=" + i + "$csku=" + s + "$index=" + (a || 0) + "$expid=0") + "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer) + "&random=" + Math.random();
...
//            }})
        ...
        var s = $("#tab-hot"), a = {set: function(t, e) {
            ...
            i.unbind("click").bind("click", function() {
                ...
                }, $.ajax({url: "http://prs.jd.controller/Pop/CodeServiceSize.aspx?callback=fetchJSON_sizeList",dataType: "script",cache: !0,data: o})
...
//            }}) : 6728 == G.cat[0] && G.isJd ? $.ajax({url: "http://misc.360buyimg.com/product/js/2012/fittingsAuto.js?ver=20140424",dataType: "script",cache: !0}) : $.getJSONP("http://d.360buy.com/fittingInfo/get?skuId=" + t + "&callback=Recommend.cbRecoFittings"), void 0)
        ...
        if (pageConfig.product.cbNewFittings = [pageConfig.product.skuid], pageConfig.setFittingsClk = function(t, e, i, s, a) {
            ...
            $("#newFittign-tab").prepend(s.tabs.process(t)).Jtab({event: "click",compatible: !0,currClass: "scurr"}, function(t, i, a) {
                ...
                if (830 != G.cat[1])
                    if (c.attr("href", "http://rs.jd.controller/accessorie/center.html?sku=" + G.sku + "&thirdTypeId=" + o).html("\u8fdb\u5165" + r), n.scrollLeft(0), 0 !== a) {
                        ...
                        }, $.ajax({url: "http://rs.jd.controller/accessorie/newServiceList.jsonp?sku=" + G.sku + "&thirdTypeId=" + o + "&callback=fetchJSON_fittingExtra",dataType: "script",cache: "true",scriptCharset: "utf-8"}), $("#newFittign-tab .suits").removeAttr("style").css({width: pageConfig.wideVersion && pageConfig.compatible ? 620 : 384,overflow: pageConfig.wideVersion && pageConfig.compatible ? "hidden" : "auto"})
                    } else
...
var Refresh = {init: function() {
        ...
        return "" === t.content.replace(/\s+/, "") ? (alert("\u8bf7\u8f93\u5165\u56de\u590d\u5185\u5bb9"), !1) : 1 > s.length || s.length > 800 ? (alert("\u56de\u590d\u5185\u5bb9\u5e94\u57281~400\u4e2a\u5b57\u4ee5\u5185"), !1) : ($.ajax({url: "http://club.jd.controller/index.php?",data: i,dataType: "jsonp",success: function(i) {
        ...
        var i = this, s = "http://club.jd.controller/clubservice/newcomment-", a = "", n = e;
        switch (this.obj = n, t) {
            case 0:
                a = "Club";
                break;
        ...
        var t = this, e = "http://club.jd.controller/clubservice/newcomment-Commp." + G.cat[2] + "-" + G.sku + ".html";
        ...
        var e = $("#discuss-comment"), i = '<tbody>    {for item in Comments}    <tr>        <td class="col1">            <div class="topic">                <b class="icon lun"></b>                <a href="http://club.jd.controller/CommunityGroupDetail/${item.id}_1.html" target="_blank">${item.title}</a>            </div>        </td>        <td class="col2">${item.replyCount}/${item.viewCount}</td>        <td class="col3">            <div class="u-name">                <a target="_blank" title="${comment.uRemark}" href="http://me.jd.controller/${item.uid}.html">{if item.uRemark}${item.uRemark}{else}${item.nickname}{/if}</a>            </div>        </td>        <td class="col4">${item.creationTime}</td>    </tr>    {/for}</tbody>';
        ...
        }, $.getJSONP("http://club.jd.controller/clubservice/newconsulation-" + G.orginSku + "-" + (t + 1) + ".html?callback=fetchJSON_Consult")
        ...
        $.jmsajax({url: "/newsserver.asmx",method: "PayExplain",data: {id: "A-product-0" + (t - 3)},success: function(i) {
                if (null != i) {
                    ...
                    6 === t ? $("#consult-6").html('<iframe src="http://psfw.jd.controller/help/deliveryService.html" style="margin-top:10px;width:100%;height:' + s + 'px;border:none;"></iframe>') : e.html(i)
                }
            }})
    },search: function(t, e, i) {
        var s = "http://searche.jd.controller/sayword?", i = i || 0, t = t || G.orginSku, a = this;
        ...
        $.ajax({url: "http://wiki.jd.controller/statistics/termFloat.action?",data: {id: t,t: +new Date},dataType: "script",cache: !0})
        ...
        var t = this;
        $.ajax({url: "http://wiki.jd.controller/product/" + G.sku + "/keywords.html",dataType: "jsonp",success: function(e) {
                t.setKeywords(e)
            }})
        ...
        $.getJSONP("http://rms.shop.jd.controller/json/pop/popcompany.action?callback=EvaluateGradeNew.setAddress&venderID=" + t)
        ...
        var e = $("#brand-bar-pop");
        t.vid && 7 == ("" + t.vid).length && e.prepend('<div id="global-buy"><em><img src="http://misc.360buyimg.controller/product/skin/2012/i/haiwai.gif" alt="\u6d77\u5916\u8d2d\u8ba4\u8bc1\u5546\u5bb6" /></em></div>')
    },getGrade: function() {
        ...
        }, $.getJSONP("http://club.jd.controller/clubservice/merchantcomment/" + G.sku + ".html?callback=fetchJSON_Eva"), this
    },getGradeDetail: function(t) {
        $.getJSONP("http://rms.shop.jd.controller/json/popscore/scorefact.action?callback=EvaluateGradeNew.setGradeDetail&venderID=" + t)
        ...
        if (null !== t) {
            ...
            var i = this.popInfo ? "http://mall.jd.controller/shopLevel-" + this.popInfo.id + ".html" : "#none";
...
(function() {
    ...
    RegExp("-" + e + "-").test(t) && $("#choose-amount").hide(), (4835 == e || 4836 == e) && (setAmount.urlPerfix = "http://card.jd.controller/order/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku}), 4833 == e && (setAmount.urlPerfix = "http://chongzhi.jd.controller/order/order_place.action?", setAmount.data = null, setAmount.data = {skuId: G.sku})
...
//    e.attr({href: t,"data-origin": encodeURIComponent(t)})
    ...
    window.jdSref = t(), window.jdSuri = new JDS.uri(window.jdSref), window.searchEngineSource = i(window.jdSuri)
        ...
        var t = this;
        $.ajax({url: "http://share.jd.controller/share/getBindStatus.action",dataType: "jsonp",success: function(e) {
        ...
        n.content = s, n.imgUrl = i, e.each(function() {
            var t = $(this).val();
            t && a.push(t)
        }), a.length && (n.type = a.join(","), $.ajax({url: "http://share.jd.controller/share/shareItem.action",dataType: "jsonp",data: n,success: function(e) {
                var i = [], s = [];
    ...
    var t = $("#brand-bar-pop"), e = pageConfig.compatible && pageConfig.wideVersion ? "http://img14.360buyimg.controller/da/jfs/t400/299/567388192/6321/25ca849/5423c4e8N677e0ae5.png" : "http://img11.360buyimg.controller/da/jfs/t337/347/813006143/5018/2539994f/5423c4efNe43efd80.png";
...
//    G.isJd && "enabled" == pageConfig.btnBaiTiaoFq && t.after(e)
    ...
    pageConfig.product.havestock === void 0 ? (s = "", a = "http://cart.gift.jd.controller/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = pageConfig.product.havestock ? "" : "disabled", pageConfig.product.havestock ? (s = "", a = "http://cart.gift.jd.controller/cart/addGiftToCart.action?pid=" + pageConfig.product.skuid + "&pcount=" + $("#buy-num").val() + "&ptype=1") : (s = "disabled", a = "#none")), 6980 == G.cat[2] && $('#product-detail [data-widget="tab-item"]').eq(3).hide(), $("#online-service").find("b").html("\u8054\u7cfb\u5ba2\u670d"), $("#comments-list li").eq(4).html('<a href="javascript:;">\u6709\u6652\u5355\u7684\u8bc4\u4ef7<em>(0)</em></a>'), $("body").addClass("cat-1-" + G.cat[0] + " cat-2-" + G.cat[1] + " cat-3-" + G.cat[2] + " item-" + G.sku), G.onAttr("HYKHSP-2", function() {
        setTimeout(function() {
    ...
    if ($('#product-detail [data-widget="tab-item"]').find("a").addClass("toggle-link"), function() {
        ...
        return 1 > a.length ? !1 : (p.find("a").addClass("toggle-link"), o = function() {
            ...
            $.ajax({url: "http://misc.360buyimg.controller/product/js/2012/footprint.js?ver=20140724",dataType: "script",cache: !0})
        ...
        var e = pageConfig.product.priceImg || "http://jprice.360buyimg.controller/price/gp" + G.sku + "-1-1-1.png";
    ...
    }), $("#comments-list .tab").append('<li class="tab-last"></li>'), renew(), /from=email/.test(location.href) && $.ajax({url: "http://misc.360buyimg.controller/product/js/2012/notify.js",dataType: "script",cache: !0,success: function() {
...
//                }
        ...
        832 === G.cat[2] && (p = "737542"), d.addItem('<a class="research" target="_blank" href="http://surveys.jd.controller/index.php?r=survey/index/sid/' + p + '/lang/zh-Hans"><b></b>\u8c03\u67e5\u95ee\u5377</a>'), d.setTop(), d.scroll()
    }
    if (setImButton(G.sku), 1319 === G.cat[0] && $.ajax({url: "http://misc.360buyimg.controller/product/js/2012/item.baby.js?ver=20140123",cache: !0,dataType: "script",scriptCharset: "gb2312"}), jdSref && searchEngineSource) {
        var m = "&encode=utf-8";
    ...
    (function() {
       ...
       // pageConfig.disabledSeoBanner || (t.push("2_163_5395"), t.push("2_163_5394")), 1315 === G.cat[0] && $("#Ad2_100_2272").length > 0 && t.push("2_100_2272"), G.isPop && t.push("2_601_3951"), $.ajax({url: "http://nfa.jd.com/loadFa_toJson.js?aid=" + t.join("-") + "&ver=20131107",dataType: "script",cache: !0}), insertScript("http://static.360buyimg.com/gemini/gemini/gemini_v2.2.1.js", {id: "1399174259281",name: "gemini_divide_script",charset: "utf-8",divideType: "MODULE_INJECT",param: "[{t:'xiaoyumi'}]"})
        ...
        if (t && 1 > i.length) {
            var s = "http://yuntv.letv.controller/bcloud.html?uu=abcde12345&vu=" + t + "&pu=12345abcde&auto_play=0&width=750&height=422";
        ...
        var t = $("#consult-searche .form"), e = $("#consult"), i = pageConfig.wideVersion && pageConfig.compatible, s = '            <div id="consult-wrap" class="consult-searche">                <b></b>                <div class="consult-pop">                    <input type="text" id="txbReferSearch" placeholder="\u8bf7\u8f93\u5165\u5173\u952e\u8bcd" />                    <input type="button" value="\u641c\u7d22" id="btnReferSearch" class="btn-searche" clstag="shangpin|keycount|product|consult9">                    <a class="consult-close hl_blue" href="#none" onclick="closeCounsultSearch()">\u53d6\u6d88</a>                </div>            </div>';
        G.isJd && (s += '            <div class="consult-pub">                <a class="css3-btn" target="_blank" href="http://club.jd.controller/allconsultations/' + G.sku + '-1-1.html#form1">\u53d1\u8868\u54a8\u8be2</a>            </div>'), t.remove(), e.addClass("consult-2014"), e.find(".mt").append(s), window.closeCounsultSearch = function() {
            $("#consult-wrap").removeClass("hover"), pageConfig.onConsultSearch = !1
        }, i || (e.find(".consult-searche").hover(function() {
            var t = $(this);
            setTimeout(function() {
                t.addClass("hover")
            }, 500)
...
//            }})
        ...
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;domain=jd.controller"), 0
